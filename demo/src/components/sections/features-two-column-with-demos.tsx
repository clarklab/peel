...
export function Feature({
  ...
  return (
    <div className={clsx('flex rounded-4xl md:rounded-2xl bg-olive-950/2.5 p-2 dark:bg-white/5', reversed ? 'flex-col-reverse' : 'flex-col', className)}>
...
export function FeaturesTwoColumnWithDemos({
  ...
  return (
    <Section {...props}>
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">{features}</div>
    </Section>
  )
}
